...
var query = {
    ...
    // 临时从后续取评论列表
    jd_goods_havecomment: "SELECT  a.wareId,  a.totalCount,  0 as lastId  FROM  jd_goods a  WHERE  totalCount > 0 and a.wareId not in (select distinct wareId from jd_comment)",
