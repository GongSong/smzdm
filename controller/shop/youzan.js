...
// 获取商品主表信息
async function getGoodsByShopName(alias = '8vcj4vsg', page = 1) {
    ...
    return await axios(config).then(res => {
        ...
        return getGoodsByShopName(alias, page + 1).then(res => [...goodItem, ...res]);
...
function getGoodsList(req, res) {
    ...
    getGoodsByShopName(shopid).then(response => {
        res.json(response);
    });
}
